...
function rpc(request, callback) {
  ...
  var errorMessage = 'Energi JSON-RPC: ';
...
RpcClient.callspec = {
  ...
  backupWallet: '',
  createMultiSig: '',
  createRawTransaction: 'obj obj int',
  ...
  getDifficulty: '',
  getGenerate: '',
  getGovernanceInfo: '', //https://github.com/energicryptocurrency/energi/blob/develop/src/rpc/governance.cpp#L901
  getHashesPerSec: '',
  getInfo: '',
  getMemoryPool: '',
  getMemPoolInfo: '',
  ...
  getSpentInfo: 'obj',
  getSuperBlockBudget: 'int', //https://github.com/energicryptocurrency/energi/blob/develop/src/rpc/governance.cpp#L959
  getTransaction: '',
  ...
  lockUnspent: '',
  masternode: 'str', //https://github.com/energicryptocurrency/energi/blob/develop/src/rpc/masternode.cpp#L111
  masternodeBroadcast: 'str', //https://github.com/energicryptocurrency/energi/blob/develop/src/rpc/masternode.cpp#L615
  masternodelist: 'str str', //https://github.com/energicryptocurrency/energi/blob/develop/src/rpc/masternode.cpp#L468
  mnsync: '', //https://github.com/energicryptocurrency/energi/blob/develop/src/rpc/misc.cpp#L146
  move: 'str str float int str',
  prioritiseTransaction: 'str float int',
  privateSend: 'str',//https://github.com/energicryptocurrency/energi/blob/develop/src/rpc/masternode.cpp#L28
  sendFrom: 'str str float int str str',
  sendMany: 'str obj int str',  //not sure this will work
  sendRawTransaction: 'str',
  sendToAddress: 'str float str str',
  sentinelPing: 'str',// https://github.com/energicryptocurrency/energi/blob/develop/src/rpc/masternode.cpp#L839
  setAccount: '',
  ...
  validateAddress: '',
  verifyMessage: '',
  voteRaw: '', // https://github.com/energicryptocurrency/energi/blob/develop/src/rpc/governance.cpp#L839
  walletLock: '',
